$(function() {
  ...
  var sqmObj = {
    ...
    "1c" : function(name, mobile, province, city, leadsID){
      _smq.push(['custom', '17-baojun', 'baojun730-millionPC-freetax-submitsuccess', '{' + name + '_' + mobile + '_' + province + '_' + city + '_' + leadsID + '_' + '}']);
      var gsq_key = "sqtywl" + new Date().getTime() + "-" + Math.floor(Math.random() * 1000);
      if (window.gsTracker) {
        var orderid = gsq_key;
        gsTracker.addOrder(orderid, 1);
    ...
    "id1": function(){
      _smq.push(['custom','17-baojun','baojun730-millionPC-funds-pickup']);
    },
    "id2": function(){
      _smq.push(['custom','17-baojun','baojun730-millionPC-pickup']);
    },
    "freetax": function(){
      _smq.push(['custom','17-baojun','baojun730-millionPC-freetax-submit']);
    },
    "rule1" : function(){
      _smq.push(['custom','17-baojun','baojun730-millionPC-rule']);
    },
    "rule2" : function(){
      _smq.push(['custom','17-baojun','baojun730-millionPC-freetax-rule']);
    },
    "reward_list" : function(){
      _smq.push(['custom','17-baojun','baojun730-millionPC-luck-namelist']);
    },
    "cookie" : function(){
      _smq.push(['custom','17-baojun','baojun730-millionPC-biscuit']);
    },
    "get_cookie" : function(){
      _smq.push(['custom','17-baojun','baojun730-millionPC-pickup']);
    },
  ...
  var video_index = 0,
      video_url = ['<iframe frameborder="0" width="1000" height="844" src="https://v.qq.com/iframe/player.html?vid=v0532ifzplw&tiny=0&auto=0" allowfullscreen></iframe>',
       '<iframe frameborder="0" width="1000" height="844" src="https://v.qq.com/iframe/player.html?vid=l0532d4s97h&tiny=0&auto=0" allowfullscreen></iframe>',
        '<iframe frameborder="0" width="1000" height="844" src="https://v.qq.com/iframe/player.html?vid=k0532t6x5w0&tiny=0&auto=0" allowfullscreen></iframe>'];
